...
const Fault01 = () => {
    ...
    return (
        <section className=' relative pb-8 pt-16'>
            <div className="container px-3 mt-20 relative z-[1]">
                <div className=" flex flex-col sm:flex-row justify-center items-start pt-2 gap-[61.66px] pl-12">
                    ...
                    <div className=" border-l-2 border-[#9800B0] pl-2" data-aos="fade-left" data-aos-duration="1000">
                ...
                <h2 className=' mt-14 text-center font-neue font-normal text-xl text-black mb-0.5' data-aos="fade-up" data-aos-duration="1000">
                ...
                <div className=" absolute -top-36 sm:-top-40 md:-top-48 lg:-top-[106%] xl:-top-[115%] left-3 flex items-start flex-col" data-aos="fade-right" data-aos-duration="1000">
                    ...
                    <div className=" flex items-end">
                        ...
                        <div className=" flex items-end -mb-3">
                            ...
                            <p className=' font-normal font-neue text-black md:text-xl lg:text-2xl uppercase lg:mb-0.5'>
                                fault
                            </p>
                        </div>
                    </div>
