...
const Footer = () => {
    return (
        <footer className='bg-[#003E92] md:min-h-[343px] relative py-8 md:pt-24 md:pb-4'>
            <div className="container px-3 relative z-[1] h-full mt-5">
                <div className=" sm:absolute top-1/2 -translate-y-1/2 right-0 flex justify-center sm:flex-col gap-3">
            ...
            <img src={layer} alt="layer" className=' absolute w-full left-0 bottom-0 xl:h-full' />
        </footer>
    )
}
