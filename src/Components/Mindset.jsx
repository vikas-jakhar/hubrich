...
const Mindset = () => {
    ...
    const slider_slides = [
        { id: 1, phase: "1st phase", title: "The not-wanting-to-be-true", description: "This phase is characterized by denial and ignoring the final separation." },
        { id: 2, phase: "2nd phase", title: "The emotional chaos", description: "This phase involves a flood of emotions such as sadness, anger, and fear." },
        { id: 3, phase: "3rd phase", title: "The reorganization", description: "In this phase, you start to reorganize your life and set new goals." },
        { id: 4, phase: "4th phase", title: "The new beginning", description: "This phase is about embracing the new life and opportunities that lie ahead." }
    ];
